...
Pod::Spec.new do |s|
  ...
  s.version          = '0.1.0'
  s.summary          = 'You can round an image with this thing'
...
TODO: Add long description of the pod here.
  ...
  s.homepage         = 'https://github.com/Vishnu/SKImageExtension'
  # s.screenshots     = 'www.example.com/screenshots_1', 'www.example.com/screenshots_2'
  s.license          = { :type => 'MIT', :file => 'LICENSE' }
  s.author           = { 'Vishnu' => '857006+vkkong@users.noreply.github.com' }
  s.source           = { :git => 'https://github.com/Vishnu/SKImageExtension.git', :tag => s.version.to_s }
